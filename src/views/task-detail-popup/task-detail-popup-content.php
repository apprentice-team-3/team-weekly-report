<form class="popup" id="task-detail-popup">
<div class="parent__task__section">
    <div class="parent__task popup__text" id="parent-task-php">親タスク</div>
        ...
        <div class="popup__text parent__progress green" id="parent-task-progress-php">100%</div>
        <button class="btn evaluation">評価</button>
        </div>
    </div>
